...
package com.tribesman.core.protocols.payments;
 ...
 *
 * <ul>
 * <li>A {@link KobocoinURI} object that conforms to BIP 0072</li>
 * <li>A url where the {@link Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link Protos.PaymentRequest} object</li>
 * </ul>
 *
 * If initialized with a KobocoinURI or a url, a network request is made for the payment request object and a
 ...
 * NOTE: sendPayment does NOT broadcast the transactions to the kobocoin network.
 *
 ...
 * @see <a href="https://github.com.tribesman/bips/blob/master/bip-0070.mediawiki">BIP 0070</a>
 */
public class PaymentSession {
     ...
     * uri is a BIP-72-style KobocoinURI object that specifies where the {@link Protos.PaymentRequest} object may
     ...
     */
    public static ListenableFuture<PaymentSession> createFromKobocoinUri(final KobocoinURI uri) throws PaymentRequestException {
        return createFromKobocoinUri(uri, true, null);
    }
     ...
     * signature cannot be verified.
     */
    public static ListenableFuture<PaymentSession> createFromKobocoinUri(final KobocoinURI uri, final boolean verifyPki)
            throws PaymentRequestException {
        return createFromKobocoinUri(uri, verifyPki, null);
    }
     ...
     */
    public static ListenableFuture<PaymentSession> createFromKobocoinUri(final KobocoinURI uri, final boolean verifyPki, @Nullable final String trustStorePath)
            throws PaymentRequestException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentRequestException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in KobocoinURI " + uri);
        try {
    ...
    private static ListenableFuture<PaymentSession> fetchPaymentRequest(final URI uri, final boolean verifyPki, @Nullable final String trustStorePath) {
        return executor.submit(new Callable<PaymentSession>() {
            ...
            public PaymentSession call() throws Exception {
                ...
                connection.setRequestProperty("Accept", "application/kobocoin-paymentrequest");
    ...
    /**
     * Returns the total amount of kobocoins requested.
     */
     ...
     * NOTE: This does not broadcast the transactions to the kobocoin network, it merely sends a Payment message to the
    ...
    protected ListenableFuture<Ack> sendPayment(final URL url, final Protos.Payment payment) {
        return executor.submit(new Callable<Ack>() {
            ...
            public Ack call() throws Exception {
                ...
                connection.setRequestProperty("Content-Type", "application/kobocoin-payment");
                connection.setRequestProperty("Accept", "application/kobocoin-paymentack");
