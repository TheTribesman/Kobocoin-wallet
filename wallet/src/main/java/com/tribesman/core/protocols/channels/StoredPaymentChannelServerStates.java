...
public class StoredPaymentChannelServerStates implements WalletExtension {
     ...
     * is measured in terms of our local clock, and the refund transaction's lock time is measured in terms of Kobocoin
        ...
        try {
            ...
            for (StoredServerChannel channel : mapChannels.values()) {
                ...
                ServerState.StoredServerPaymentChannel.Builder channelBuilder = ServerState.StoredServerPaymentChannel.newBuilder()
                        ...
                        .setContractTransaction(ByteString.copyFrom(channel.contract.kobocoinSerialize()))
                        .setClientOutput(ByteString.copyFrom(channel.clientOutput.kobocoinSerialize()))
