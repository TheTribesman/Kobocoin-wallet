...
package com.tribesman.core.kits;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV kobocoinj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit kobocoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing kobocoinj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the kobocoinj website for further details.
     */
