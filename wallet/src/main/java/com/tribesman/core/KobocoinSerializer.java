...
/**
 * <p>Methods to serialize and de-serialize messages to the Kobocoin network format as defined in
 * <a href="https://en.kobocoin.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.kobocoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class KobocoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(KobocoinSerializer.class);
    ...
    /**
     * Constructs a KobocoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public KobocoinSerializer(NetworkParameters params) {
     ...
     */
    public KobocoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("KobocoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
        serialize(name, message.kobocoinSerialize(), out);
    }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A Kobocoin protocol message has the following format.
        //
        ...
        KobocoinPacketHeader header = new KobocoinPacketHeader(in);
     ...
     */
    public KobocoinPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new KobocoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link KobocoinSerializer#deserializeHeader}.
     */
    public Message deserializePayload(KobocoinPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class KobocoinPacketHeader {
        ...
        public KobocoinPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
