 ...
 * convenience methods on {@link com.tribesman.core.Transaction}, but they are useful when working with the
...
public class ScriptBuilder {
    ...
    public static Script createInputScript(TransactionSignature signature, ECKey pubKey) {
        ...
        return new ScriptBuilder().data(signature.encodeToKobocoin()).data(pubkeyBytes).build();
    }

    /** Creates a scriptSig that can redeem a pay-to-pubkey output. */
    public static Script createInputScript(TransactionSignature signature) {
        return new ScriptBuilder().data(signature.encodeToKobocoin()).build();
    }
    ...
    public static Script createMultiSigInputScript(List<TransactionSignature> signatures) {
        ...
        for (TransactionSignature signature : signatures)
            sigs.add(signature.encodeToKobocoin());
     ...
     * <a href="https://github.com.tribesman/bips/blob/master/bip-0016.mediawiki">BIP 16</a> to learn more about this
     * kind of script.
     */
