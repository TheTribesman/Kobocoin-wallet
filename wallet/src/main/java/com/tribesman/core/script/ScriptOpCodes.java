...
/**
 * Various constants that define the assembly-like scripting language that forms part of the Kobocoin protocol.
 * See {@link com.tribesman.core.script.Script} for details. Also provides a method to convert them to a string.
 */
