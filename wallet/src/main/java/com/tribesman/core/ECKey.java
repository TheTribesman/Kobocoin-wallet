...
import com.tribesman.wallet.NativeSecp256k1;
 ...
 *
 * <p>ECKey also provides access to Kobocoin-Qt compatible text message signing, as accessible via the UI or JSON-RPC.
...
public class ECKey implements Serializable {
    ...
    /** The parameters of the secp256k1 curve that Kobocoin uses. */
    ...
    static {
        // All clients must agree on the curve to use by agreement. Kobocoin uses secp256k1.
    ...
    /**
     * Construct an ECKey from an ASN.1 encoded private key. These are produced by OpenSSL and stored by the Kobocoin
    ...
    /**
     * Output this ECKey as an ASN.1 encoded private key, as understood by OpenSSL or used by the Kobocoin reference
     ...
     * how ECDSA signatures are represented when embedded in other data structures in the Kobocoin protocol. The raw
    ...
    public static class ECDSASignature {
         ...
         * the same message. However, we dislike the ability to modify the bits of a Kobocoin transaction after it's
    ...
    /**
     * Signs a text message using the standard Kobocoin messaging signing format and returns the signature as a base64
     * encoded string.
     *
    ...
    /**
     * Given an arbitrary piece of text and a Kobocoin-format message signature encoded in base64, returns an ECKey
     * containing the public key that was used to sign it. This can then be compared to the expected public key to
     * determine if the signature was correct. These sorts of signatures are compatible with the Kobocoin-Qt/kobocoind
     * format generated by signmessage/verifymessage RPCs and GUI menu options. They are intended for humans to verify
     * their communications with each other, hence the base64 format and the fact that the input is text.
     *
     * @param message Some piece of human readable text.
     * @param signatureBase64 The Kobocoin-format message signature in base64
     ...
     *
     * Because it is a critical failure if the private keys cannot be decrypted successfully (resulting of loss of all kobocoins controlled
