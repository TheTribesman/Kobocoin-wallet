...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
    ...
    // Minimum protocol version we will allow ourselves to connect to: Do not require bloom filtering as it doesn't exist in Kobocoin
     ...
     * <a href="https://github.com.tribesman/bips/blob/master/bip-0014.mediawiki">BIP 14</a>.
     *
     ...
     * used normally - let the PeerGroup manage connections through}
     * 
     ...
     * someone and want to know that it's valid. It's a bit of a weird hack because the current version of the Kobocoin
