...
public class VersionMessage extends Message {
    ...
    public static final String KobocoinJ_VERSION = "2.1.1";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/KobocoinJ:" + KobocoinJ_VERSION + "/";
    ...
    @Override
    public void kobocoinSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.kobocoinSerialize(buf);
            // Their address.
            theirAddr.kobocoinSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for KobocoinJ
     * users might look like "/KobocoinJ:0.4-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/KobocoinJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.<p>
     *
     * See <a href="https://github.com.tribesman/bips/blob/master/bip-0014.mediawiki">BIP 14</a> for more information.
     *
