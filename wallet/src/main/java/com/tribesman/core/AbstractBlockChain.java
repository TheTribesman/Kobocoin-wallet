...
public abstract class AbstractBlockChain {
     ...
     */
    protected com.tribesman.core.StoredBlock chainHead;
    ...
    public final com.tribesman.core.NetworkParameters params;
    private final CopyOnWriteArrayList<ListenerRegistration<com.tribesman.core.BlockChainListener>> listeners;

    // Holds a block header and, optionally, a list of tx hashes or block's transactions
    class OrphanBlock {
        final com.tribesman.core.Block block;
        final List<com.tribesman.core.Sha256Hash> filteredTxHashes;
        final Map<com.tribesman.core.Sha256Hash, com.tribesman.core.Transaction> filteredTxn;
        OrphanBlock(com.tribesman.core.Block block, @Nullable List<com.tribesman.core.Sha256Hash> filteredTxHashes, @Nullable Map<com.tribesman.core.Sha256Hash, com.tribesman.core.Transaction> filteredTxn) {
    ...
    private final LinkedHashMap<com.tribesman.core.Sha256Hash, OrphanBlock> orphanBlocks = new LinkedHashMap<com.tribesman.core.Sha256Hash, OrphanBlock>();
     ...
     */
    public AbstractBlockChain(com.tribesman.core.NetworkParameters params, List<com.tribesman.core.BlockChainListener> listeners,
        ...
        this.params = params;
        this.listeners = new CopyOnWriteArrayList<ListenerRegistration<com.tribesman.core.BlockChainListener>>();
        for (com.tribesman.core.BlockChainListener l : listeners) addListener(l, Threading.SAME_THREAD);
    }
     ...
     */
    public void addWallet(com.tribesman.core.Wallet wallet) {
    ...
    public void removeWallet(com.tribesman.core.Wallet wallet) {
     ...
     */
    public void addListener(com.tribesman.core.BlockChainListener listener) {
     ...
     * Adds a generic {@link BlockChainListener} listener to the chain.
     */
    public void addListener(com.tribesman.core.BlockChainListener listener, Executor executor) {
        listeners.add(new ListenerRegistration<com.tribesman.core.BlockChainListener>(listener, executor));
    }

    /**
     * Removes the given {@link BlockChainListener} from the chain.
     */
    public void removeListener(com.tribesman.core.BlockChainListener listener) {
     ...
     */
    protected abstract com.tribesman.core.StoredBlock addToBlockStore(com.tribesman.core.StoredBlock storedPrev, com.tribesman.core.Block block)
            throws BlockStoreException, com.tribesman.core.VerificationException;
     ...
     * @return the newly created {@link StoredBlock}
     */
    protected abstract com.tribesman.core.StoredBlock addToBlockStore(com.tribesman.core.StoredBlock storedPrev, com.tribesman.core.Block header,
                                                   @Nullable com.tribesman.core.TransactionOutputChanges txOutputChanges)
            throws BlockStoreException, com.tribesman.core.VerificationException;
     ...
     */
    protected abstract void doSetChainHead(com.tribesman.core.StoredBlock chainHead) throws BlockStoreException;
     ...
     */
    protected abstract com.tribesman.core.StoredBlock getStoredBlockInCurrentScope(com.tribesman.core.Sha256Hash hash) throws BlockStoreException;
     ...
     */
    public boolean add(com.tribesman.core.Block block) throws com.tribesman.core.VerificationException, com.tribesman.core.PrunedException {
        try {
            ...
            throw new com.tribesman.core.VerificationException("Could not verify block " + block.getHashAsString() + "\n" +
                    block.toString(), e);
        }
    }
     ...
     * If the block can be connected to the chain, returns true.
     */
    public boolean add(com.tribesman.core.FilteredBlock block) throws com.tribesman.core.VerificationException, com.tribesman.core.PrunedException {
        try {
            ...
            throw new com.tribesman.core.VerificationException("Could not verify block " + block.getHash().toString() + "\n" +
                    block.toString(), e);
        }
    }
     ...
     */
    protected abstract com.tribesman.core.TransactionOutputChanges connectTransactions(int height, com.tribesman.core.Block block) throws com.tribesman.core.VerificationException, BlockStoreException;
     ...
     * @return The full set of all changes made to the set of open transaction outputs.
     */
    protected abstract com.tribesman.core.TransactionOutputChanges connectTransactions(com.tribesman.core.StoredBlock newBlock) throws com.tribesman.core.VerificationException, BlockStoreException, com.tribesman.core.PrunedException;
    ...
    private boolean add(com.tribesman.core.Block block, boolean tryConnecting,
                        @Nullable List<com.tribesman.core.Sha256Hash> filteredTxHashList, @Nullable Map<com.tribesman.core.Sha256Hash, com.tribesman.core.Transaction> filteredTxn)
            throws BlockStoreException, com.tribesman.core.VerificationException, com.tribesman.core.PrunedException {
        lock.lock();
        try {
            ...
            if (shouldVerifyTransactions() && block.transactions == null)
                throw new com.tribesman.core.VerificationException("Got a block header while running in full-block mode");
            ...
            com.tribesman.core.StoredBlock storedPrev = getStoredBlockInCurrentScope(block.getPrevBlockHash());
            ...
            if (storedPrev == null) {
    		    ...
    		    try {
    				if (!validHashStore.isValidHash(block.getHash(), this, block.getTimeSeconds() > System.currentTimeMillis()/1000 - 60*60*3)) {
    				   throw new com.tribesman.core.VerificationException("Invalid hash received");
    				}
    			} catch (IOException e) {
    ...
    private void connectBlock(final com.tribesman.core.Block block, com.tribesman.core.StoredBlock storedPrev, boolean expensiveChecks,
                              @Nullable final List<com.tribesman.core.Sha256Hash> filteredTxHashList,
                              @Nullable final Map<com.tribesman.core.Sha256Hash, com.tribesman.core.Transaction> filteredTxn) throws BlockStoreException, com.tribesman.core.VerificationException, com.tribesman.core.PrunedException {
        checkState(lock.isHeldByCurrentThread());
        boolean filtered = filteredTxHashList != null && filteredTxn != null;
        // Check that we aren't connecting a block that fails a checkpoint check
        if (!params.passesCheckpoint(storedPrev.getHeight() + 1, block.getHash()))
            throw new com.tribesman.core.VerificationException("Block failed checkpoint lockin at " + (storedPrev.getHeight() + 1));
        if (shouldVerifyTransactions()) {
            checkNotNull(block.transactions);
            for (com.tribesman.core.Transaction tx : block.transactions)
                if (!tx.isFinal(storedPrev.getHeight() + 1, block.getTimeSeconds()))
                   throw new com.tribesman.core.VerificationException("Block contains non-final transaction");
        }
        
        com.tribesman.core.StoredBlock head = getChainHead();
        if (storedPrev.equals(head)) {
            if (filtered && filteredTxn.size() > 0)  {
                ...
                for (com.tribesman.core.Sha256Hash hash : filteredTxHashList) log.debug("  matched tx {}", hash);
            }
            if (expensiveChecks && block.getTimeSeconds() <= getMedianTimestampOfRecentBlocks(head, blockStore))
                throw new com.tribesman.core.VerificationException("Block's timestamp is too early");
            
            // This block connects to the best known block, it is a normal continuation of the system.
            com.tribesman.core.TransactionOutputChanges txOutChanges = null;
            if (shouldVerifyTransactions())
                txOutChanges = connectTransactions(storedPrev.getHeight() + 1, block);
            com.tribesman.core.StoredBlock newStoredBlock = addToBlockStore(storedPrev,
            ...
            com.tribesman.core.StoredBlock newBlock = storedPrev.build(block);
            boolean haveNewBestChain = newBlock.moreWorkThan(head);
            if (haveNewBestChain) {
                log.info("Block is causing a re-organize");
            } else {
                com.tribesman.core.StoredBlock splitPoint = findSplit(newBlock, head, blockStore);
                ...
                if (splitPoint == null) {
                    ...
                    throw new com.tribesman.core.VerificationException("Block forks the chain but splitPoint is null");
                } else {
    ...
    private void informListenersForNewBlock(final com.tribesman.core.Block block, final NewBlockType newBlockType,
                                            @Nullable final List<com.tribesman.core.Sha256Hash> filteredTxHashList,
                                            @Nullable final Map<com.tribesman.core.Sha256Hash, com.tribesman.core.Transaction> filteredTxn,
                                            final com.tribesman.core.StoredBlock newStoredBlock) throws com.tribesman.core.VerificationException {
        ...
        boolean first = true;
        Set<com.tribesman.core.Sha256Hash> falsePositives = Sets.newHashSet();
        if (filteredTxHashList != null) falsePositives.addAll(filteredTxHashList);
        for (final ListenerRegistration<com.tribesman.core.BlockChainListener> registration : listeners) {
                ...
                registration.executor.execute(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            Set<com.tribesman.core.Sha256Hash> ignoredFalsePositives = Sets.newHashSet();
                            informListenerForNewTransactions(block, newBlockType, filteredTxHashList, filteredTxn,
    ...
    private static void informListenerForNewTransactions(com.tribesman.core.Block block, NewBlockType newBlockType,
                                                         @Nullable List<com.tribesman.core.Sha256Hash> filteredTxHashList,
                                                         @Nullable Map<com.tribesman.core.Sha256Hash, com.tribesman.core.Transaction> filteredTxn,
                                                         com.tribesman.core.StoredBlock newStoredBlock, boolean first,
                                                         com.tribesman.core.BlockChainListener listener,
                                                         Set<com.tribesman.core.Sha256Hash> falsePositives) throws com.tribesman.core.VerificationException {
        if (block.transactions != null) {
            ...
            for (com.tribesman.core.Sha256Hash hash : filteredTxHashList) {
                com.tribesman.core.Transaction tx = filteredTxn.get(hash);
                if (tx != null) {
     ...
     */
    private static long getMedianTimestampOfRecentBlocks(com.tribesman.core.StoredBlock storedBlock,
     ...
     */
    protected abstract void disconnectTransactions(com.tribesman.core.StoredBlock block) throws com.tribesman.core.PrunedException, BlockStoreException;
     ...
     */
    private void handleNewBestChain(com.tribesman.core.StoredBlock storedPrev, com.tribesman.core.StoredBlock newChainHead, com.tribesman.core.Block block, boolean expensiveChecks)
            throws BlockStoreException, com.tribesman.core.VerificationException, com.tribesman.core.PrunedException {
        checkState(lock.isHeldByCurrentThread());
        ...
        com.tribesman.core.StoredBlock head = getChainHead();
        final com.tribesman.core.StoredBlock splitPoint = findSplit(newChainHead, head, blockStore);
        log.info("Re-organize after split at height {}", splitPoint.getHeight());
        log.info("Old chain head: {}", head.getHeader().getHashAsString());
        log.info("New chain head: {}", newChainHead.getHeader().getHashAsString());
        log.info("Split at block: {}", splitPoint.getHeader().getHashAsString());
        // Then build a list of all blocks in the old part of the chain and the new part.
        final LinkedList<com.tribesman.core.StoredBlock> oldBlocks = getPartialChain(head, splitPoint, blockStore);
        final LinkedList<com.tribesman.core.StoredBlock> newBlocks = getPartialChain(newChainHead, splitPoint, blockStore);
        // Disconnect each transaction in the previous main chain that is no longer in the new main chain
        com.tribesman.core.StoredBlock storedNewHead = splitPoint;
        if (shouldVerifyTransactions()) {
            for (com.tribesman.core.StoredBlock oldBlock : oldBlocks) {
                try {
                    disconnectTransactions(oldBlock);
                } catch (com.tribesman.core.PrunedException e) {
            ...
            com.tribesman.core.StoredBlock cursor;
            // Walk in ascending chronological order.
            for (Iterator<com.tribesman.core.StoredBlock> it = newBlocks.descendingIterator(); it.hasNext();) {
                cursor = it.next();
                if (expensiveChecks && cursor.getHeader().getTimeSeconds() <= getMedianTimestampOfRecentBlocks(cursor.getPrev(blockStore), blockStore))
                    throw new com.tribesman.core.VerificationException("Block's timestamp is too early during reorg");
                com.tribesman.core.TransactionOutputChanges txOutChanges;
     ...
     */
    private static LinkedList<com.tribesman.core.StoredBlock> getPartialChain(com.tribesman.core.StoredBlock higher, com.tribesman.core.StoredBlock lower, BlockStore store) throws BlockStoreException {
        checkArgument(higher.getHeight() > lower.getHeight(), "higher and lower are reversed");
        LinkedList<com.tribesman.core.StoredBlock> results = new LinkedList<com.tribesman.core.StoredBlock>();
        com.tribesman.core.StoredBlock cursor = higher;
        while (true) {
            results.add(cursor);
     ...
     */
    private static com.tribesman.core.StoredBlock findSplit(com.tribesman.core.StoredBlock newChainHead, com.tribesman.core.StoredBlock oldChainHead,
                                         BlockStore store) throws BlockStoreException {
        com.tribesman.core.StoredBlock currentChainCursor = oldChainHead;
        com.tribesman.core.StoredBlock newChainCursor = newChainHead;
    ...
    private static void sendTransactionsToListener(com.tribesman.core.StoredBlock block, NewBlockType blockType,
                                                   com.tribesman.core.BlockChainListener listener,
                                                   int relativityOffset,
                                                   List<com.tribesman.core.Transaction> transactions,
                                                   boolean clone,
                                                   Set<com.tribesman.core.Sha256Hash> falsePositives) throws com.tribesman.core.VerificationException {
        for (com.tribesman.core.Transaction tx : transactions) {
            try {
                if (listener.isTransactionRelevant(tx)) {
                    falsePositives.remove(tx.getHash());
                    if (clone)
                        tx = new com.tribesman.core.Transaction(tx.params, tx.kobocoinSerialize());
    ...
    protected void setChainHead(com.tribesman.core.StoredBlock chainHead) throws BlockStoreException {
     ...
     */
    private void tryConnectingOrphans() throws com.tribesman.core.VerificationException, BlockStoreException, com.tribesman.core.PrunedException {
        checkState(lock.isHeldByCurrentThread());
        ...
        do {
            ...
            while (iter.hasNext()) {
                ...
                com.tribesman.core.StoredBlock prev = getStoredBlockInCurrentScope(orphanBlock.block.getPrevBlockHash());
                if (prev == null) {
     ...
     */
    private void checkDifficultyTransitions(com.tribesman.core.StoredBlock storedPrev, com.tribesman.core.Block nextBlock) throws BlockStoreException, com.tribesman.core.VerificationException {
	    // No difficulty checks, placing trust in central hashes
    }

    private void checkTestnetDifficulty(com.tribesman.core.StoredBlock storedPrev, com.tribesman.core.Block prev, com.tribesman.core.Block next) throws com.tribesman.core.VerificationException, BlockStoreException {
        checkState(lock.isHeldByCurrentThread());
        ...
        // goes backwards.
        if (timeDelta >= 0 && timeDelta <= com.tribesman.core.NetworkParameters.TARGET_SPACING * 2) {
            // Walk backwards until we find a block that doesn't have the easiest proof of work, then check
            // that difficulty is equal to that one.
            com.tribesman.core.StoredBlock cursor = storedPrev;
            ...
            if (!cursorDifficulty.equals(newDifficulty))
                throw new com.tribesman.core.VerificationException("Testnet block transition that is not allowed: " +
     ...
     */
    private boolean containsRelevantTransactions(com.tribesman.core.Block block) {
     ...
     */
    public com.tribesman.core.StoredBlock getChainHead() {
        synchronized (chainHeadLock) {
            return chainHead;
        }
    }
     ...
     */
    @Nullable
    public com.tribesman.core.Block getOrphanRoot(com.tribesman.core.Sha256Hash from) {
        lock.lock();
        try {
    ...
    public boolean isOrphan(com.tribesman.core.Sha256Hash block) {
        lock.lock();
        try {
     ...
     */
    public ListenableFuture<com.tribesman.core.StoredBlock> getHeightFuture(final int height) {
        final SettableFuture<com.tribesman.core.StoredBlock> result = SettableFuture.create();
        addListener(new com.tribesman.core.AbstractBlockChainListener() {
            @Override
