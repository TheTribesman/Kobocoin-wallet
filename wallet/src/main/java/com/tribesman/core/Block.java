...
import static com.tribesman.core.X15.x15Digest;

/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the Kobocoin system.
 ...
 * <a href="http://www.kobocoin.org/kobocoin.pdf">the Kobocoin technical paper</a> for
...
public class Block extends Message {
     ...
     * upgrade everyone to change this, so Kobocoin can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /** Constructs a block object from the Kobocoin wire format. */
    ...
    /**
     * Contruct a block object from the Kobocoin wire format.
    ...
    /**
     * <p>A utility method that calculates how much new Kobocoin would be created by the block at the given height.
     * The inflation of Kobocoin is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
    ...
    /** Returns the version of the block data structure as defined by the Kobocoin protocol. */
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, BigInteger value) {
        ...
        coinbase.length = coinbase.kobocoinSerialize().length;
