...
import com.tribesman.core.net.AbstractTimeoutHandler;
import com.tribesman.core.net.MessageWriteTarget;
import com.tribesman.core.net.StreamParser;
 ...
 * {@link com.tribesman.core.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link com.tribesman.core.net.NioClient} or
     * {@link com.tribesman.core.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
