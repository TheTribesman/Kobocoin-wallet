 ...
 *
 * A BlockStore is a map of hashes to StoredBlock. The hash is the double digest of the Kobocoin serialization
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.tribesman.core.BlockChain#getChainHead()}
     * or perhaps {@link com.tribesman.core.BlockChain#getBestChainHeight()} which will run in constant time and
