...
import wallettemplate.controls.KobocoinAddressValidator;
...
public class SendMoneyController {
    ...
    public void initialize() {
        new KobocoinAddressValidator(Main.params, address, sendBtn);
    }
    ...
    public void send(ActionEvent event) {
        try {
            ...
            sendResult = Main.kobocoin.wallet().sendCoins(req);
