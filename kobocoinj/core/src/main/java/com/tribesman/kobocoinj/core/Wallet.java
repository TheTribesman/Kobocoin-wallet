...
import org.kobocoinj.wallet.Protos.Wallet.EncryptionType;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.tribesman.kobocoinj.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public static class SendRequest {
        ...
        /**
         * If not null, the {@link com.tribesman.kobocoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.tribesman.kobocoinj.wallet.WalletFiles.Listener)}
