...
public class KobocoinSerializerTest {
    ...
    public void testAddr() throws Exception {
        KobocoinSerializer bs = new KobocoinSerializer(MainNetParams.get());
        // the actual data from https://en.kobocoin.it/wiki/Protocol_specification#addr
    ...
    public void testLazyParsing()  throws Exception {
        KobocoinSerializer bs = new KobocoinSerializer(MainNetParams.get(), true, false);
    ...
    private void testCachedParsing(boolean lazy)  throws Exception {
        KobocoinSerializer bs = new KobocoinSerializer(MainNetParams.get(), lazy, true);
    ...
    @Test
    public void testKobocoinPacketHeader() {
        try {
            new KobocoinSerializer.KobocoinPacketHeader(ByteBuffer.wrap(new byte[]{0}));
            fail();
        ...
        try {
            new KobocoinSerializer.KobocoinPacketHeader(ByteBuffer.wrap(wrongMessageLength));
            fail();
    ...
    public void testSeekPastMagicBytes() {
        ...
        try {
            new KobocoinSerializer(MainNetParams.get()).seekPastMagicBytes(ByteBuffer.wrap(brokenMessage));
            fail();
        } catch (BufferUnderflowException e) {
            // expected
        }
