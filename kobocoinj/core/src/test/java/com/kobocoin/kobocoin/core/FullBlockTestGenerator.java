...
public class FullBlockTestGenerator {
    // Used by KobocoindComparisonTool and AbstractFullPrunedBlockChainTest to create test cases
    ...
    public RuleList getBlocksToTest(boolean addSigExpensiveBlocks, boolean runLargeReorgs, File blockStorageFile) throws ScriptException, ProtocolException, IOException {
            ...
            public boolean add(Rule element) {
                if (outStream != null && element instanceof BlockAndValidity) {
                    try {
                        ...
                        byte[] block = ((BlockAndValidity)element).block.kobocoinSerialize();
        ...
        // Extend the b24 chain to make sure kobocoind isn't accepting b24
        ...
        // Extend the b26 chain to make sure kobocoind isn't accepting b26
        ...
        // Extend the b28 chain to make sure kobocoind isn't accepting b28
        ...
        Block b56;
        try {
            b56 = new Block(params, b57.kobocoinSerialize());
        ...
        Block b64;
        {
            ...
            for (Transaction transaction : b64Created.getTransactions())
                transaction.kobocoinSerialize(stream);
            ...
            Preconditions.checkState(Arrays.equals(stream.toByteArray(), b64.kobocoinSerialize()));
        ...
        Block b71 = new Block(params, b72.kobocoinSerialize());
